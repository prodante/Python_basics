...
print(f'Исходный списк: {my_list}')
duc_inter = {i: my_list.count(i) for i in my_list}
new_list = [key for key, var in duc_inter.items() if var == 1]
print(f'{" "*5}Результат: {new_list}')